...
class Ball {
    ...
    public static function getActiveBalls() {
...
$ballList = array($football, $bouncyball);

for ($i = 0; $i < count($ballList); $i++) {
    $ballList[$i] -> printInfo();
}

echo 'Active balls: ' . Ball::getActiveBalls();
